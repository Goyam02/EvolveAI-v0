...
//           <h1 className="font-display text-7xl md:text-8xl lg:text-[10rem] xl:text-[11rem] leading-[0.85] tracking-tight mb-8 text-[#35103C] font-black select-none drop-shadow-lg w-[1160px]">
//             Evolve AI
//           </h1>
          
//           {/* Subtitle with enhanced readability */}
//           <p className="font-body text-xl md:text-2xl lg:text-3xl text-[#35103C] text-800 font-medium tracking-wide leading-relaxed drop-shadow-sm">
